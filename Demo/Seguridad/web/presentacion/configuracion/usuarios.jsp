...
<%
    ...
    for(int i=0;i< datos.size();i++){
        ...
        lista+="<td>"+persona.getNombre()+"</td>";
        lista+="<td>"+persona.getUsuario()+"</td>";
        lista+="<td>"+persona.getTipo()+"</td>";
        lista+="<td>";
        lista+="<a href='principal.jsp?CONTENIDO=configuracion/usuariosFormulario.jsp&accion=Modificar&id="+persona.getId()+"' title='Modificar'><img src='imagenes/modificar.png'></a>";
        lista+="<label Onclick='eliminar("+persona.getId()+")'><img src='imagenes/eliminar.png'></label>";
        lista+="</td>";
        lista+="</tr>";
    }
...
<h3>USUARIOS</h3>
<table border="1px">
    <tr><th>Id</th><th>Nombre</th><th>Usuario</th><th>Tipo</th><th><a href="principal.jsp?CONTENIDO=configuracion/usuariosFormulario.jsp"><img src='imagenes/adicionar.png'></a></th></tr>
    <%=lista%>
</table>
