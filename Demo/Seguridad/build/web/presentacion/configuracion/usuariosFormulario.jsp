...
<%
 ...
 <form id="for" name="formulario" method="post" action="principal.jsp?CONTENIDO=configuracion/usuariosActualizar.jsp">
     <table border="1">
         <tr><th>Nombre(*)</th><td><input type="text" name="nombre" value="<%=persona.getNombre()%>" size="50" maxlength="50" required></td></tr>
         ...
         <tr><th>Tipo(*)</th><td><select name="tipo"><%=persona.getTipoEnObjetos()%></select></td></tr>
